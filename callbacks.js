...
function intersection() {
  ...
  arrays.forEach((array) => {
    frequencyCount = reduce(array, addOneToNumberFrequency, {
      ...frequencyCount,
    });
  });

  for (const key in frequencyCount) {
    if (frequencyCount[key] === arguments.length) intersections.push(key);
  }

  return intersections;
}
function addOneToNumberFrequency(accumulator, element) {
